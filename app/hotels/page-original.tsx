...
export default function HotelsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gray-50 pt-20"><div className="container mx-auto px-4 py-8"><div className="text-center">Loading...</div></div></div>}>
      <HotelsPageContent />
    </Suspense>
  );
}
              ...
              {Array.isArray(hotels) && hotels.length > 0 && hotels.map((hotel) => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={() => setHighlightedHotelId(h.hotelId || h.id || null)}
                    ...
                    <div className="flex h-48">
                      ...
                      <div className="relative w-64 h-full">
                        {(() => {
                          ...
                          const currentIndex = currentImageIndex[String(h.hotelId || h.id)] || 0;
                          ...
                          return (
                            <>
                              ...
                              <button
                                onClick={() => setCurrentImageIndex(prev => ({
                                  ...prev,
                                  [String(h.hotelId || h.id)]: currentIndex > 0 ? currentIndex - 1 : hotelImages.length - 1
                                }))}
                              ...
                              <button
                                onClick={() => setCurrentImageIndex(prev => ({
                                  ...prev,
                                  [String(h.hotelId || h.id)]: currentIndex < hotelImages.length - 1 ? currentIndex + 1 : 0
                                }))}
